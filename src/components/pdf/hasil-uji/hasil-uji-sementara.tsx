...
export const HasilUjiSementaraPDF = ({ data }: { data: { sampel: Sampel | null; surat: Surat[] } }) => {
        ...
        <View style={styles.ttdContainer}>
          ...
          <View style={styles.ttdRow}>
            ...
            <View style={styles.ttdCol}>
              ...
              <Text style={styles.ttdNama}>{data?.surat?.[0]?.penerima_tugas?.[0].nama_pegawai ?? "Tidak ada ketua tim"}</Text>
            ...
            <View style={styles.ttdCol}>
              ...
              <Text style={styles.ttdNama}>{data?.surat?.[0]?.penerima_tugas?.[1]?.nama_pegawai ?? "Tidak ada penerima tugas"}</Text>

              <Text style={styles.ttdNip}>NIP. {data?.surat?.[0]?.penerima_tugas?.[1]?.nip ?? "Tidak ada NIP"}</Text>
            </View>
          </View>
        </View>
      </Page>
